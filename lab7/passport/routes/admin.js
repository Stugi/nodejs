...
/*Роут организующий отдачу секретной информации. Вторым аргументов передается промежуточный
обработчик, который проверяет авторизован ли пользователь или нет. Полный путь: /admin/secret */
